      ...
      >
        ...
        <a
          ...
          className="
            ...
            px-4 py-2
            bg-gradient-to-b from-cyan-300/80 to-cyan-400/80 hover:from-cyan-400/90 hover:to-cyan-500/90
            rounded-full
            text-slate-900
            font-medium
            ...
            relative
            before:absolute before:inset-0 before:bg-gradient-to-b before:from-white/40 before:to-transparent before:rounded-full before:pointer-events-none
          "
        >
